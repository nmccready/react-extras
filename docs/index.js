...
const features = ['hooks', 'components', 'utilities'];
...
const Main = () => (
  <React.Fragment>
    <Container py={5}>
      ...
      <Pre>yarn add @znemz/react-extras-hooks</Pre>
      <Pre>yarn add @znemz/react-extras-hooks-use-sort-by</Pre>
      <Pre>yarn add @znemz/react-extras-jest</Pre>
      <Flex py={4}>
        <Button
          is="a"
          px={4}
          py={3}
          bg="black"
          href="https://github.com/nmccready/react-extras"
        >
          Github
        </Button>
        <Box mx={1} />
